...
game_name = "Gopher-v4"
environment_name = "GopherNoFrameskip-v4"
...
def train_agent(n_iterations):      # Training code
    time_step = None
...
epsilon_fn = keras.optimizers.schedules.PolynomialDecay(
    ...
    decay_steps=100_000// update_period, # <=> 1,000,000 ALE frames
...
# Collect driver for playing game and collecting policy:
...
train_agent(n_iterations=300_000)
print("\nTime Taken: ", time.time() - start_time)
# beep_when_finished()

# Saving models and policies:
...
# Stiching together frames and creating GIF:
